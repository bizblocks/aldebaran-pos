...
#include "worker.h"
#include "ui_dlgselectdiscount.h"
...
void alOrderWindow::init()
{
    ...
    btnGroup = new Q3Frame(this, "grpOrderTableButtons");
    btnGroup->setMargin(5);
...
{
    Ui_dlgSelectDiscount * dlg = new Ui_dlgSelectDiscount();
    dlg->setupUi((QDialog*)this);
    //TODO port qt4
    //dlg->init(fEngine);
//    if(dlg->exec())
//    {
