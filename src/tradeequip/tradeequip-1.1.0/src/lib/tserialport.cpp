...
{
	BaudRateType spd = BAUD_NOTSET;
	switch (baudrate) 
	{
	    case 0:
	    case 300:	spd = BAUD300;	break;
	    case 600:	spd = BAUD600;	break;
	    case 1200:	spd = BAUD1200;	break;
	    case 2400:	spd = BAUD2400;	break;
	    case 4800:	spd = BAUD4800;	break;
	    case 9600:	spd = BAUD9600;	break;
	    case 19200:	spd = BAUD19200;break;
	    case 38400:	spd = BAUD38400;break;
	    case 57600:	spd = BAUD57600;break;
	    case 115200:spd = BAUD115200;break;
	    default: return;
	}
	superclass::setBaudRate((BaudRateType)spd);
	return;
