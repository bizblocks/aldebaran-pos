/****************************************************************************
** $Id: tereaderbase.h,v 1.11 2006/07/04 06:07:07 red75 Exp $
**
...
public slots:
    ...
    virtual bool startDriver(); // open port, then start polling it
    virtual bool stopDriver(); // stop polling, then closes port
