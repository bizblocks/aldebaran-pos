...
#ifndef CONFIGFELIXRK_H

#define CONFIGFELIXRK_H
#include <teglobal.h> // Config from tradeequip
#ifdef FELIX_BUILD
#  define FELIX_EXPORT LIB_DLLEXPORT
#  define FELIX_TEMPLATE_EXTERN
#else
#  define FELIX_EXPORT LIB_DLLIMPORT
#  define FELIX_TEMPLATE_EXTERN TEMPLATE_EXTERN
#endif
