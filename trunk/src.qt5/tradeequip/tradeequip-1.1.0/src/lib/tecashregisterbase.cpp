/****************************************************************************
** $Id: tecashregisterbase.cpp,v 1.17 2006/07/04 06:07:06 red75 Exp $
**
...
*/
TECashRegisterBase::TECashRegisterBase( QString pname, unsigned long nm )
:TEBase( pname )
{
    vMachineNumber = nm;
	vCashSum=0;
